all_patches;
%%% all stay trials together %%%%%%
stay_1= {};
for xx= 1:length(all_patches)
    stay_1= [stay_1,all_patches{xx}(end-1)];
end
Q= [stay_1{:}];
...
for i= 1:s
    box= p(i)-0:p(i)+100;              % identification of blink
...
average(w(4):w(5))= [avg{:,2}];
plot(average)
%%%% reconstruction of trials%%%
hold on
trial= t_1(:,1);
t_3= isnan(trial);
p= find(t_3==1);
